...
class CIFAR100(DatasetBase):
    ...
    def __init__(self, cfg):
        ...
        self.split_path = os.path.join(self.dataset_dir, "split_CIFAR100.json")
    ...
    @ staticmethod
    def read_and_split_data(train_image_dir, test_image_dir, p_trn=0.7, ignored=[], new_cnames=None):
