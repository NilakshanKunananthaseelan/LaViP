...
from mm_dassl.utils import (
    MetricMeter, AverageMeter, tolist_if_not, count_num_param, load_checkpoint,
    save_checkpoint, mkdir_if_missing, resume_from_checkpoint,
    load_pretrained_weights
)
from mm_dassl.modeling import build_head, build_backbone
from mm_dassl.evaluation import build_evaluator
...
class TrainerBase:
    ...
    def load_model(self, directory, epoch=None):
        ...
        for name in names:
            ...
            #! changed from official (strict=True)
